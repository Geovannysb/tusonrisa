...
import torch                                  
from flask import Flask, jsonify, render_template, request, send_file, make_response, url_for      #lib para crear el servidor web
...
def predictUrl(url):
        ...
        shutil.copy(".\\runs\\detect\\exp\\"+contenido[0], ".\\static\\foto_detectada.jpg")
...
if __name__ == "__main__":
    ...
    #application.run(host="0.0.0.0", port=5000, debug=True)  # Inicia en servidor Local
